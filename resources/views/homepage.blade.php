...
<body>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active"> 
                ...
                <div class="carousel-caption">
                    <h3>Nail Service</h3>
                    <a class="btn btn-default btn-outline-light btn-lg" style="color: #6648b1;" href="https://www.bokadirekt.se/places/nail-art-of-sweden-15679">Book</a>
    ...
    <div class="container padding">
        <div class="row text-center">
            ...
            <div class="col-12">
                <p class="lead intro-info">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum recusandae quis corporis,
    ...
    <div class="container-fluid padding">
        <div class="row d-flex justify-content-center text-center">
                ...
                <div class="mapouter">
                    <div class="gmap_canvas">
                        <iframe width="100%" height="100%" id="gmap_canvas"
                            src="https://maps.google.com/maps?q=uppsala&t=&z=17&ie=UTF8&iwloc=&output=embed"
            ...
            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12">
                ...
                <p class="text-left">labella@gmail.com</p>
